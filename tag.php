...
/*
    ...
    Tag page (for posts with a certain tag)
*/
...
<main>
    ...
    <div class="container pt-1">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Posts tagged “<?php single_tag_title(); ?>”</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="container-fluid px-0 pt-1 pb-5">
        <div class="container">
            <h1 class="display-4 text-white text-center">Posts tagged “<?php single_tag_title(); ?>”</h1>
